...
exports.autoDistribution = exports.server = exports.app = void 0;
// backend/src/server.ts
const express_1 = __importDefault(require("express"));
const cors_1 = __importDefault(require("cors"));
const socket_io_1 = require("socket.io");
const http_1 = __importDefault(require("http"));
const AutoDistributionService_1 = __importDefault(require("./services/AutoDistributionService"));
...
app.use((0, security_1.requestSizeLimit)(1024 * 1024)); // 1MB limit
app.use(security_1.sanitizeHeaders);
app.use(express_1.default.json({ limit: '1mb' })); // Reduced from 10mb for security
app.use(express_1.default.urlencoded({ extended: true, limit: '1mb' }));
// Apply sanitization after body parsing
app.use(security_1.sanitizeRequestBody);
app.use(security_1.sanitizeQueryParams);
...
const autoDistribution = new AutoDistributionService_1.default();
exports.autoDistribution = autoDistribution;
...
async function saveDistributionToDatabase(event) {
    try {
